  ...
  return (
    <div className=''>
      ...
      <div className='flex container mx-auto justify-between'>
        <div className='flex'>
          <img src="https://www.tiquetesytiquetes.com/static/img/logo.png" alt="logo" />
        </div>
      ...
      <div className='container mx-auto py-16'>
        ...
        <div className="w-full h-48 bg-slate-100 rounded-lg border border-1 border-[#00829059] shadow-sm shadow-[#66c3cf]">          
          <div className='py-6 px-12'>
            <h1 className="uppercase text-lg text-[#008290] font-semibold">Vuelos baratos con tiquetesytiquetes</h1>
          </div>
          ...
          <div className='flex items-center pl-12 pt-4'>
            <div>
              ...
              <div className='bg-gray-200 rounded-lg p-2 -mr-3 w-48'>
                <p className='text-sm uppercase font-medium ml-7 tracking-wide'>Origen</p>
                <div className='flex'>
                  <span className='mr-1'>
                  ...
                  <input className='w-full rounded-md border border-gray-200 bg-gray-200 text-base font-medium text-[#6B7280] outline-none focus:border-[#6b64f100] focus:shadow-sm' type="text" placeholder='Desde'/>
                </div>
              </div>             
            ...
            <div>
              ...
              <div className='bg-gray-200 rounded-lg p-2 -ml-3 w-48'>
                <p className='text-sm uppercase font-medium ml-7 tracking-wide'>Destino</p>
                <div className='flex'>
                  <span className='mr-1'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                  ...
                  <input className='w-full rounded-md border border-gray-200 bg-gray-200 text-base font-medium text-[#6B7280] outline-none focus:border-transparent focus:shadow-sm' type="text" placeholder='Desde'/>
                </div>
              </div>             
